...
class folio_report(report_sxw.rml_parse):
    ...
    def get_data(self, date_start, date_end):
        tids = self.pool.get('hotel.folio').search(self.cr, self.uid, [
            ('checkin_date', '>=', date_start), ('checkout_date', '<=', date_end)])
...
report_sxw.report_sxw('report.folio.total', 'hotel.folio',
                      'addons/hotel/report/total_folio.rml', parser=folio_report)
